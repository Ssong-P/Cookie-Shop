...
//		Assert.assertNotNull(productService.getProduct(10049));
	...
	//@Test
	public void testGetProductLustByProdNo() throws Exception {

		Search search = new Search();
		search.setCurrentPage(1);
		search.setPageSize(3);
		search.setSearchCondition("0");
		search.setSearchKeyword("10048");
		Map<String, Object> map = productService.getProductList(search);
	...
	// @Test
	public void testGetProductLustByProdName() throws Exception {
		...
		search.setSearchCondition("1");
		// 현재시간을 초단위로 찍는중 -> 랜덤
		search.setSearchKeyword("아아" + System.currentTimeMillis());
		map = productService.getProductList(search);
	...
	//@Test
	public void testGetProductLustByPrice() throws Exception {
