...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<tr class="ct_list_pop">
		...
		<td align="left">
			...
			배송중...
			 <a href="/updateTranCodeByProd.do?prodNo=<%=purchase.getPurchaseProd().getProdNo()%>&tranCode=003">상품도착</a>
			...
			<c:choose>
				...
				<c:when test="${purchase.tranCode eq '002'}">
					배송중
					<a href="/updateTranCodeByProd.do?prodNo=${purchase.purchaseProd.prodNo}&tranCode=003">상품도착</a>
				</c:when>
